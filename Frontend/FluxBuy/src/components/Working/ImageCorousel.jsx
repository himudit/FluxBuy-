...
//                         src={img}
//                         alt={`slide-${index}`}
//                         className={`absolute top-0 left-0 w-fulltransition-opacity duration-1000 w-full h-[400px] object-cover  mb-4 rounded ${index === current ? 'opacity-100 z-10' : 'opacity-0 z-0'
//                             }`}
//                     />
//                 ))
//             }
